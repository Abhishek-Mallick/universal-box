  ...
  return (
    <div className='flex justify-center min-h-56 p-[11px]'>
      <div className="relative z-20 w-full max-w-md bg-[#040b18] bg-opacity-90 px-8 py-10 rounded-lg shadow-lg backdrop-blur-md">
        <h2 className="text-center text-3xl font-bold text-white mb-4">Terms of Service</h2>
        <p className="text-white">
          This is a dummy Terms of Service page. You can add your terms of service content here.
        </p>
      </div>
    </div>
  );
