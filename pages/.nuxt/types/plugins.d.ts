...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../node_modules/@nuxtjs/plausible/dist/runtime/plugin-auto-pageviews.client").default> &
...
declare module '#app' {
  ...
  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'nuxt:global-components' | 'nuxt:prefetch' | 'nuxt:checkIfPageUnused' | 'plausible' | 'nuxt:checkIfLayoutUsed' | 'plausible:auto-pageviews'
  }
}
